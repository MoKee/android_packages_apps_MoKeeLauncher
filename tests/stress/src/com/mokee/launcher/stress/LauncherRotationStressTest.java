...
package com.mokee.launcher.stress;


import com.mokee.launcher.Launcher;
...
/**
 * Run rotation stress test using MoKeeLauncher for 50 iterations.
 */
public class LauncherRotationStressTest extends ActivityInstrumentationTestCase2<Launcher> {
    ...
    private static final String LOG_TAG = "MoKeeLauncherRotationStressTest";
